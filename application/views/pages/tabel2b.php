        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Mahasiswa Asing</a></li>
              <li class="breadcrumb-item active">Tabel2b</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title"><b>Data Tabel2b </b></h3>
						...
						<div class="card-body table-responsive">
							...
							<table class="table table-striped table-bordered table-hover dataku">
								...
								<tbody>
									...
									<tr>
										<td><?php echo $no; ?></td>
										<td><?php echo $tabel2b->fakultas; ?></td>
										<td><?php echo $tabel2b->ts2; ?></td>
										<td><?php echo $tabel2b->ts1; ?></td>
										<td><?php echo $tabel2b->ts; ?></td>
										<td>
						...
						<div class="modal-content">
								...
								<div class="modal-body">
									...
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">Fakultas</label>
										<div class="col-md-10">
											<input type="text" name="fakultas" id="fakultas" class="form-control" value="<?= $tabel2b->fakultas ?>" >
										</div>
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">TS2</label>
										<div class="col-md-10">
											<input type="text" name="ts2" id="ts2" class="form-control" value="<?= $tabel2b->ts2 ?>" >
										</div>
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">TS1</label>
										<div class="col-md-10">
											<input type="text" name="ts1" id="ts1" class="form-control" value="<?= $tabel2b->ts1 ?>">
										</div>
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">TS</label>
										<div class="col-md-10">
											<input type="text" name="ts" id="ts" class="form-control" value="<?= $tabel2b->ts ?>" >
										</div>
									</div>
								</div>
								<br><br>
