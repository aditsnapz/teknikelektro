			...
			<div class="row">
						...
						<div class="card-header">
							...
							<div class="text-right">
								<button type="button" class="btn btn-sm btn-warning" data-toggle="modal"
									data-target="#import-tabel11"><i class="fa fa-upload"></i>&nbsp&nbspImport</button>
						...
						<div class="card-body table-responsive">
							...
							<table class="table table-striped table-bordered table-hover dataku">
								...
								<tbody>
									...
									<tr>
										<td><?php echo $no; ?></td>
										<td><?php echo $tabel11->mitra; ?></td>
										<td><?php echo $tabel11->internasional; ?></td>
										<td><?php echo $tabel11->nasional; ?></td>
										<td><?php echo $tabel11->wilayah; ?></td>
										<td><?php echo $tabel11->judul; ?></td>
										<td><?php echo $tabel11->manfaat; ?></td>
										<td><?php echo $tabel11->waktu; ?></td>
										<td><?php echo $tabel11->bukti; ?></td>
										<td><?php echo $tabel11->tahun; ?></td>
										
										<td>
											<button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
												data-target="#edit-tabel11<?php echo $tabel11->id;?>"><i
													class="fa fa-edit"></i>&nbsp&nbspUpdate</button>
											<a class="btn btn-danger btn-sm delete-link" href="<?= base_url('Tabel11/delete/'.$tabel11->id);?>"><i
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title"><strong>Tambah Tabel11</strong></h4>
								...
								<br>
								<form method="POST" action="<?php echo base_url('Tabel11/add'); ?>" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="modal fade" id="edit-tabel11<?php echo $tabel11->id;?>">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title">Edit Tabel11</h4>
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span></button>
									
								</div>
								<form method="POST" action="<?php echo base_url('Tabel11/edit'); ?>" enctype="multipart/form-data" class="form-horizontal">
								<div class="modal-body">
									<div class="form-group row">
										<input type="hidden" name="id" id="id" class="form-control" value="<?= $tabel11->id ?>" >
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">Mitra</label>
										<div class="col-md-10">
											<input type="text" name="mitra" id="mitra" class="form-control" value="<?= $tabel11->mitra ?>" >
										</div>
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">Internasional</label>
										<div class="col-md-10">
											<input type="text" name="internasional" id="internasional" class="form-control" value="<?= $tabel11->internasional ?>">
										</div>
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">Nasional</label>
										<div class="col-md-10">
											<input type="text" name="nasional" id="nasional" class="form-control" value="<?= $tabel11->nasional ?>" >
										</div>
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">wilayah</label>
										<div class="col-md-10">
											<input type="text" name="wilayah" id="wilayah" class="form-control" value="<?= $tabel11->wilayah ?>" >
										</div>
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">Judul</label>
										<div class="col-md-10">
											<input type="text" name="judul" id="judul" class="form-control" value="<?= $tabel11->judul ?>">
										</div>
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">Manfaat</label>
										<div class="col-md-10">
											<input type="text" name="manfaat" id="manfaat" class="form-control" value="<?= $tabel11->manfaat ?>" >
										</div>
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">Waktu</label>
										<div class="col-md-10">
											<input type="text" name="waktu" id="waktu" class="form-control" value="<?= $tabel11->waktu ?>" >
										</div>
									</div>
									<div class="form-group row">
										<label for="nama" class="col-md-2 col-form-label">Bukti</label>
				...
				<!-- /.modal -->
				<?php $no++; } ?>
				<div class="modal fade" id="import-tabel11" >
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title"><strong>Import Tabel11</strong></h4>
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
								...
								<br>
								<form method="POST" action="<?php echo base_url('Tabel11/import'); ?>" enctype="multipart/form-data" class="form-horizontal">
								<div class="modal-body">
									<div class="form-group row">
