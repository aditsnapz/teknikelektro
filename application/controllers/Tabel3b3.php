...
class Tabel3b3 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel3b3Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel3b3s = $this->Tabel3b3Model->show();
    ...
    public function add()
    {
        ...
        $this->Tabel3b3Model->insert($data);
        redirect(base_url('Tabel3b3'));
    ...
    public function edit()
    {
        ...
        $this->Tabel3b3Model->update($data, $id);
        redirect(base_url('Tabel3b3'));
    }

    public function delete($id)
    {
        $this->Tabel3b3Model->delete($id);
        redirect(base_url('Tabel3b3'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel3b3Model->insert_batch($datains);
        		redirect(base_url('Tabel3b3'));           
			} catch (Exception $e) {
