...
class Tabel13 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel13Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel13s = $this->Tabel13Model->show();
    ...
    public function add()
    {
        ...
        $this->Tabel13Model->insert($data);
        redirect(base_url('Tabel13'));
    ...
    public function edit()
    {
        ...
        $this->Tabel13Model->update($data, $id);
        redirect(base_url('Tabel13'));
    }

    public function delete($id)
    {
        $this->Tabel13Model->delete($id);
        redirect(base_url('Tabel13'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel13Model->insert_batch($datains);
        		redirect(base_url('Tabel13'));           
			} catch (Exception $e) {
