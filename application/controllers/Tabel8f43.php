...
class Tabel8f43 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel8f43Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel8f43s = $this->Tabel8f43Model->show();
    ...
    public function add()
    {
        ...
        $this->Tabel8f43Model->insert($data);
        redirect(base_url('Tabel8f43'));
    ...
    public function edit()
    {
        ...
        $this->Tabel8f43Model->update($data, $id);
        redirect(base_url('Tabel8f43'));
    }

    public function delete($id)
    {
        $this->Tabel8f43Model->delete($id);
        redirect(base_url('Tabel8f43'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel8f43Model->insert_batch($datains);
        		redirect(base_url('Tabel8f43'));           
			} catch (Exception $e) {
