...
class Tabel3c2 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel3c2Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel3c2s = $this->Tabel3c2Model->show();
    ...
    public function add()
    {
        ...
        $this->Tabel3c2Model->insert($data);
        redirect(base_url('Tabel3c2'));
    ...
    public function edit()
    {
        ...
        $this->Tabel3c2Model->update($data, $id);
        redirect(base_url('Tabel3c2'));
    }

    public function delete($id)
    {
        $this->Tabel3c2Model->delete($id);
        redirect(base_url('Tabel3c2'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel3c2Model->insert_batch($datains);
        		redirect(base_url('Tabel3c2'));           
			} catch (Exception $e) {
