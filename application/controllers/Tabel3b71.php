...
class Tabel3b71 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel3b71Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel3b71s = $this->Tabel3b71Model->show();
    ...
    public function add()
    {
        ...
        $this->Tabel3b71Model->insert($data);
        redirect(base_url('Tabel3b71'));
    ...
    public function edit()
    {
        ...
        $this->Tabel3b71Model->update($data, $id);
        redirect(base_url('Tabel3b71'));
    }

    public function delete($id)
    {
        $this->Tabel3b71Model->delete($id);
        redirect(base_url('Tabel3b71'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel3b71Model->insert_batch($datains);
        		redirect(base_url('Tabel3b71'));           
			} catch (Exception $e) {
