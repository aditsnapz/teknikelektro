...
class Tabel3b72 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel3b72Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel3b72s = $this->Tabel3b72Model->show();
    ...
    public function add()
    {
        ...
        $this->Tabel3b72Model->insert($data);
        redirect(base_url('Tabel3b72'));
    ...
    public function edit()
    {
        ...
        $this->Tabel3b72Model->update($data, $id);
        redirect(base_url('Tabel3b72'));
    }

    public function delete($id)
    {
        $this->Tabel3b72Model->delete($id);
        redirect(base_url('Tabel3b72'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel3b72Model->insert_batch($datains);
        		redirect(base_url('Tabel3b72'));           
			} catch (Exception $e) {
