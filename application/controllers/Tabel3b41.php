...
class Tabel3b41 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel3b41Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel3b41s = $this->Tabel3b41Model->show();
      
        $this->load->view('main.php',[
            "page" => "tabel3b41",
			"title" => "Tabel3b41",
			"subtitle" => "Publikasi Ilmiah DTPS",
            "content" => [],
            "tabel3b41s" => $tabel3b41s, 
        ]);
    }
    ...
    public function add()
    {
        ...
        $this->Tabel3b41Model->insert($data);
        redirect(base_url('Tabel3b41'));
    ...
    public function edit()
    {
        ...
        $this->Tabel3b41Model->update($data, $id);
        redirect(base_url('Tabel3b41'));
    }

    public function delete($id)
    {
        $this->Tabel3b41Model->delete($id);
        redirect(base_url('Tabel3b41'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel3b41Model->insert_batch($datains);
        		redirect(base_url('Tabel3b41'));           
			} catch (Exception $e) {
