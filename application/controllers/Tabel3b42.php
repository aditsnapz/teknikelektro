...
class Tabel3b42 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel3b42Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel3b42s = $this->Tabel3b42Model->show();
      
        $this->load->view('main.php',[
            "page" => "tabel3b42",
			"title" => "Tabel3b42",
			"subtitle" => "Pagelaran/Pameran/Presentasi/Publikasi Ilmiah DTPS",
            "content" => [],
            "tabel3b42s" => $tabel3b42s, 
        ]);
    }
    ...
    public function add()
    {
        ...
        $this->Tabel3b42Model->insert($data);
        redirect(base_url('Tabel3b42'));
    ...
    public function edit()
    {
        ...
        $this->Tabel3b42Model->update($data, $id);
        redirect(base_url('Tabel3b42'));
    }

    public function delete($id)
    {
        $this->Tabel3b42Model->delete($id);
        redirect(base_url('Tabel3b42'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel3b42Model->insert_batch($datains);
        		redirect(base_url('Tabel3b42'));           
			} catch (Exception $e) {
