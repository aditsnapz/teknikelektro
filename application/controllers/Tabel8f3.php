...
class Tabel8f3 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel8f3Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel8f3s = $this->Tabel8f3Model->show();
      
        $this->load->view('main.php',[
            "page" => "tabel8f3",
			"title" => "Tabel8f3",
			"subtitle" => "Produk/Jasa Mahasiswa yang Diadopsi oleh Industri/Masyarakat",
            "content" => [],
            "tabel8f3s" => $tabel8f3s, 
        ]);
    }
    ...
    public function add()
    {
        ...
        $this->Tabel8f3Model->insert($data);
        redirect(base_url('Tabel8f3'));
    ...
    public function edit()
    {
        ...
        $this->Tabel8f3Model->update($data, $id);
        redirect(base_url('Tabel8f3'));
    }

    public function delete($id)
    {
        $this->Tabel8f3Model->delete($id);
        redirect(base_url('Tabel8f3'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel8f3Model->insert_batch($datains);
        		redirect(base_url('Tabel8f3'));           
			} catch (Exception $e) {
