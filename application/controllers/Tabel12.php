...
class Tabel12 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel12Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel12s = $this->Tabel12Model->show();
    ...
    public function add()
    {
        ...
        $this->Tabel12Model->insert($data);
        redirect(base_url('Tabel12'));
    ...
    public function edit()
    {
        ...
        $this->Tabel12Model->update($data, $id);
        redirect(base_url('Tabel12'));
    }

    public function delete($id)
    {
        $this->Tabel12Model->delete($id);
        redirect(base_url('Tabel12'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel12Model->insert_batch($datains);
        		redirect(base_url('Tabel12'));           
			} catch (Exception $e) {
