...
class Tabel3b74 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Tabel3b74Model');
        $this->path = 'assets/images/';
    }

	public function index()
	{
        $tabel3b74s = $this->Tabel3b74Model->show();
    ...
    public function add()
    {
        ...
        $this->Tabel3b74Model->insert($data);
        redirect(base_url('Tabel3b74'));
    ...
    public function edit()
    {
        ...
        $this->Tabel3b74Model->update($data, $id);
        redirect(base_url('Tabel3b74'));
    }

    public function delete($id)
    {
        $this->Tabel3b74Model->delete($id);
        redirect(base_url('Tabel3b74'));
	}
	...
	public function import() 
	{
		if ($this->input->post('submit')) {
			...
			if(empty($error)){
				...
				$this->Tabel3b74Model->insert_batch($datains);
        		redirect(base_url('Tabel3b74'));           
			} catch (Exception $e) {
